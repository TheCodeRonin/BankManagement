...
public class Main {
    ...
    static String ACCOUNTS_FILE = "src/main/data/accounts";
    static String TRANSACTIONS_FILE = "src/main/data/transactions";
    ...
    public static Account createObject(String[] values) {
        try {
            return (Account)Class.forName("main.model.accounts." + values[0])
